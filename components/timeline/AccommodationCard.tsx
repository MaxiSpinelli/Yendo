      ...
      <div className="card p-4 border-l-4 border-l-amber-400 hover:shadow-md transition-shadow">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-8 h-8 rounded-lg bg-amber-light flex items-center justify-center flex-shrink-0">
              <span className="text-base">🏨</span>
            </div>
            <div className="min-w-0">
              <p className="font-semibold text-navy-900 text-sm truncate">{accommodation.name}</p>
              <p className="text-xs text-navy-300 mt-0.5 truncate">{accommodation.address}</p>
            </div>
          </div>
